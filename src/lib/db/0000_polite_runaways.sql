...
--> statement-breakpoint
ALTER TABLE "loadout" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "loadout" ADD CONSTRAINT "operator_fk" FOREIGN KEY ("operator_id") REFERENCES "public"."operator"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "loadout" ADD CONSTRAINT "gadget_fk" FOREIGN KEY ("gadget_id") REFERENCES "public"."gadget"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "loadout" ADD CONSTRAINT "pweapon_fk" FOREIGN KEY ("pweapon_id") REFERENCES "public"."weapon"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "loadout" ADD CONSTRAINT "sweapon_fk" FOREIGN KEY ("sweapon_id") REFERENCES "public"."weapon"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_operator_id" ON "loadout" USING btree ("operator_id" int4_ops);--> statement-breakpoint
CREATE INDEX "idx_user_id" ON "loadout" USING btree ("user_id" text_ops);--> statement-breakpoint
...
CREATE POLICY "User can view their own tasks" ON "loadout" AS PERMISSIVE FOR SELECT TO "authenticated";--> statement-breakpoint
CREATE POLICY "Users must insert their own tasks" ON "loadout" AS PERMISSIVE FOR INSERT TO "authenticated";--> statement-breakpoint
